...
namespace Microsoft.CodeAnalysis.Tools.Reflection
{
    ...
    {
        private static readonly Assembly? s_microsoftCodeAnalysisCodeStyleFixesAssembly = Assembly.Load(new AssemblyName("Microsoft.CodeAnalysis.CodeStyle.Fixes"));
        private static readonly Type? s_abstractRemoveUnnecessaryImportsCodeFixProviderType = s_microsoftCodeAnalysisCodeStyleFixesAssembly?.GetType("Microsoft.CodeAnalysis.RemoveUnnecessaryImports.AbstractRemoveUnnecessaryImportsCodeFixProvider");
